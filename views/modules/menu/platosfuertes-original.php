...
<div class="container-fluid mb-5">
    <div class="migajas  mt-4">
        <div class="container migajas-container">
            ...
            <a class="migajas__link" href="alimentos"> Alimentos</a> > Platos Fuertes
        </div>
    </div>
</div>
             ...
             <div class="main-menu-image main-menu-image--vh ">
              ...
              <div class="portada-menu portada-menu--platos-fuertes">
                <div class="filtro-portada">
                 
                    <div class="main-menu__title-container main-menu__title-container--bottom m-4">
                            <h1 class="main-menu__title text-right mb-5 w-75 justify-content-end"> 
                                Platos<br>Fuertes 
                            </h1>
                        </div>
                   </div>  
                ...
                <div class="main-menu-container">
                  <!-- list style principal (version 1) -->
                     <ul class="main-menu-list">
                        ...
                        <li class="main-menu-list__item">ACAMAYAS EN SALSA DE GUANABANA
                            <span class="main-menu-list__item-price">$495.00</span>
                        </li>
                        <p class="main-menu-list__description">
                        (Preparadas a la parrilla con guarnición de arroz y verduras a la mantequilla).
                        </p>  
...
pure de papa rústico en una salsa picante con hormiga chicatana).
                        ...
                        <li class="main-menu-list__item">MAGRET DE POLLO
                              <span class="main-menu-list__item-price">$280.00</span>
                        </li>
                        <p class="main-menu-list__description">
                        (Marinado en mezcal y cilantro acompañado de chimichurri mexicano y esquites de elote dulce).
                        </p>  
                        

                        <li class="main-menu-list__item">TORTITAS DE AMARANTO
                              <span class="main-menu-list__item-price">$195.00</span>
                        </li>
                        <p class="main-menu-list__description">
                        (Servidas con arroz en caldillo de jitomate con chipotle).
                        </p>  
                        ...
                        <li class="main-menu-list__item">HAMBURGUESA PORTOBELLO
                              <span class="main-menu-list__item-price">$380.00</span>
                        </li>
                        <p class="main-menu-list__description">
                        (Portoblello relleno de hamburguesa de rib eye y acompañado con verduras tempura).
                        </p>  
                        

                        <li class="main-menu-list__item">HAMBURGUESA VEGANA
                              <span class="main-menu-list__item-price">$280.00</span>
                        </li>
                        <p class="main-menu-list__description">
...
<!-- fin div contenedor single page -->
            ...
            <div class="mb-5 mt-3">
                <a class="btn btn-primary" href="alimentos">Volver</a>
            </div>
