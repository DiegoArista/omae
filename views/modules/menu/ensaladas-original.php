...
<div class="container-fluid mb-5">
    <div class="migajas  mt-4">
        <div class="container migajas-container">
            ...
            <a class="migajas__link" href="alimentos"> Alimentos</a> > Ensaladas
        </div>
    </div>
</div>
             ...
             <div class="main-menu-image main-menu-image--vh ">
              ...
              <div class="portada-menu portada-menu--ensaladas">
                ...
                <div class="main-menu-container">
                  <!-- list style principal (version 1) -->
                     <ul class="main-menu-list">
                        <li class="main-menu-list__item">ENSALADA DE KALE
...
aguacate).
                        ...
                        <li class="main-menu-list__item">ENSALADA DE KALE CON
POLLO
                        ...
                        <li class="main-menu-list__item">ENSALADA DE KELE CON
ACAMAYAS
                            <span class="main-menu-list__item-price">$290.00</span>
                        </li>
                        <p class="main-menu-list__description">
                        (Con acamayas a la parrilla).
                        </p>  
                        <li class="main-menu-list__item">ENSALADA CÉSAR
                            <span class="main-menu-list__item-price">$145.00</span>
                        </li>
                        <p class="main-menu-list__description">
...
ACAMAYAS 
                        ...
                        <li class="main-menu-list__item">ENSALADA OMAE
                            <span class="main-menu-list__item-price">$145.00</span>
                        </li>
                        <p class="main-menu-list__description">
